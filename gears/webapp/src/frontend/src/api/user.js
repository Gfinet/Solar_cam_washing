...
const getSessions = async () => {
	return client.get("/api/v1/user/sessions").then((res) => res.data);
};

const deleteSession = async (id) => {
	return client.delete("/api/v1/user/session/" + id).then((res) => res.data);
};

const deleteAllSessions = async () => {
	return client.delete("/api/v1/user/sessions").then((res) => {});
};
