        ...
        <div v-if="!pending" data-form="login">
            ...
            <template v-else-if="!mfaRequired">
                ...
                <div class="ff-actions">
                    ...
                    <template v-if="fortyTwoSSOEnabled">
                        <hr class="mb-4">
                        <ff-button class="w-full space-x-2" kind="secondary" data-action="42-login"  @click="signInWith42()" :disabled="loggingIn">
...
export default {
    ...
    methods: {
        ...
        signInWith42() {
            window.location.href = "/sso/login/42";
        }
    },
    computed: {
        ...
        fortyTwoSSOEnabled () {
            return this.settings['platform:sso:42'] && this.settings['platform:sso:42:clientId']
        }
    },
    async mounted () {
        await this.$nextTick()
